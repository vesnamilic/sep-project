...
public class ClientController {
	...
	public ResponseEntity<?> addClient(@RequestHeader("Authorization") String authorization, @RequestBody String clientString) {		
		...
		logger.info("INITIATED | Adding a new client to the database");
	    ...
	    try {
	      ...
	      email = (String) response.getBody();
	    	...
	    	logger.error("CANCELED | Adding a new client to the database");
		...
		if(newClient != null) {
			logger.info("COMPLETED | Adding a new client to the database");
